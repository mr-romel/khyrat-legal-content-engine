...
- جميع تعليقات Facebook المطلوب توليدها تُكتب بلسان "متابع/فرد من الجمهور" وليس بلسان الصفحة أو المحامي.
- إذا كان التعليق سؤالًا، يجب أن يبدو كسؤال حقيقي صادر من شخص قرأ المنشور ويريد الاستفسار عن حالته أو فهم نقطة فيه.
- استخدم صيغًا طبيعية مثل: "طب لو...؟"، "طيب لو حصل معايا...؟"، "هل ده ينطبق لو...؟"، "ولو أنا في الحالة دي أعمل إيه؟"، "عندي موقف مشابه..." بحسب الموضوع، ولا تستخدم صياغة توحي بأن الصفحة هي التي تسأل جمهورها.
- ممنوع أن تبدأ تعليقات الجمهور بصيغ من نوع: "إيه رأيكم؟" أو "مين حصل معاه؟" أو "تحبوا نتكلم عن إيه؟" أو أي سؤال صادر من الصفحة للجمهور.
- لا تكتب "اكتب سؤالك في التعليقات" داخل تعليق يفترض أنه صادر من متابع؛ هذا CTA خاص بالصفحة ويُترك للمنشور نفسه.
- لا تدّعي أن شخصًا حقيقيًا تواصل مع الصفحة أو أن هذه حالة حقيقية محددة؛ التعليقات يجب أن تكون بصيغة أسئلة ومواقف محتملة تبدو طبيعية.
- يمكن أن تتضمن بعض التعليقات طلبًا للمعلومة أو توضيحًا أو موقفًا افتراضيًا، وبعضها مشاركة طبيعية للمنشور، لكن لا تجعلها كلها أسئلة متشابهة.

تعليقات Facebook يجب أن تكون متنوعة في الوظيفة والأسلوب، وليست إعادة صياغة للمنشور.
وزّعها عند ملاءمة الموضوع بين: أسئلة حقيقية بلسان الجمهور، طلب توضيح، حالة محتملة، تصحيح تصور شائع، ملاحظة قانونية بسيطة، فتح نقاش من منظور المتابع، ودعوة طبيعية لمشاركة المنشور عندما يكون ذلك منطقيًا.
...
Facebook: مصري طبيعي، تفاعلي، بسيط، مهني، وجميع التعليقات بلسان متابع من الجمهور.
أهم شرط: لا تجعل الصفحة تسأل الجمهور. كل سؤال يجب أن يكون سؤال متابع قرأ المنشور ويريد فهم نقطة أو معرفة هل تنطبق القاعدة على موقف محتمل.
مثال على الاتجاه الصحيح: "طب لو العقد مكتوب بس من غير شهود، كده الموقف القانوني بيختلف؟"
مثال آخر: "طيب لو حصل معايا نفس الموقف ده، أبدأ بإيه؟"
الاتجاه الخاطئ: "إيه رأيكم في الموضوع؟" أو "مين حابب يعرف تفاصيل أكتر؟" أو "اكتبوا لنا أسئلتكم".
لا تستخدم أي صياغة توحي بأن التعليق صادر من الصفحة أو المحامي.
لا تدّعِ أن التعليق صادر عن شخص حقيقي أو أنه تجربة حقيقية؛ استخدم مواقف محتملة وطبيعية فقط.
اجعل التعليقات متنوعة بوضوح: أسئلة متابعة، حالات محتملة، طلب توضيح، اعتراض منطقي، تصحيح تصور، ومشاركة طبيعية عند ملاءمتها.
اجعل بعض التعليقات قصيرة جدًا وبعضها أطول قليلًا حتى لا تبدو مولدة بقالب واحد.
لا تجعل أكثر من عدد محدود منها يطلب المشاركة مباشرة، ولا تكرر نفس CTA.
عندما تطلب مشاركة المنشور، اجعل الطلب طبيعيًا ومبررًا بالفائدة، مثل شخص قد يحتاج المعلومة.
لا تكتب "اكتب سؤالك في التعليقات" في أي تعليق من تعليقات الجمهور.
