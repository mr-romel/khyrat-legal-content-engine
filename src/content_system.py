...
VOICE_PROFILE = {
    ...
    "forbidden": "لغة AI نمطية؛ مقدمات طويلة؛ تخويف بلا سند؛ وعود بنتيجة قضائية؛ حشو قانوني غير لازم؛ تكرار نفس الزاوية؛ علامات التنصيص؛ النقطة في نهاية الجمل؛ أي إشارة إلى الذكاء الاصطناعي أو طريقة إنتاج النص.",
