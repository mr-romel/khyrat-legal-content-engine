...
SEEDS: dict[str, tuple[str, list[str]]] = {
    ...
    "قانون الشركات والاستثمار": (
        ...
        [
            ...
            "الجمعية العامة", "مجلس الإدارة", "حوكمة الشركات", "تعارض المصالح في الشركة", "عقود الشركة مع الأطراف المرتبطة",
    ...
    "قانون الأسرة": (
        ...
        [
            ...
            "التطليق للضرر", "الخلع", "المتعة ومؤخر الصداق", "إثبات النسب", "السفر بالمحضون وضوابطه", "منع السفر في مسائل الأسرة",
