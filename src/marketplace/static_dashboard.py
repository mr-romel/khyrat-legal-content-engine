...
<title>خيرت — Marketplace Dashboard</title>
<style>
...
<div class="wrap">
<header>
<h1>مركز متابعة سوق خدمات خيرت</h1>
<p class="muted">لوحة تفاعلية — تعديلات الحالات والعروض محفوظة على هذا الجهاز.</p>
<div class="toolbar"><input id="search" placeholder="بحث في الفرص والخدمات..." oninput="draw()"><button onclick="resetState()">إرجاع بيانات البداية</button></div>
<div class="notice">GitHub Pages لا يشغّل Python/API. لذلك السحب من مستقل وتوليد المحتوى بالذكاء الاصطناعي يحتاجان Backend منشور. وظائف إدارة ومراجعة وتحرير البيانات المحلية تعمل داخل المتصفح.</div>
</header>
<div id="stats" class="grid"></div>
<section><h2>فرص مستقل</h2><div id="opportunities" class="items"></div></section>
<section><h2>خدمات خمسات</h2><div id="services" class="items"></div></section>
<section><h2>Portfolio</h2><div id="portfolio" class="items"></div></section>
<section><h2>سجل النشاط</h2><ul id="activity"></ul></section>
</div>
<div id="msg"></div>
<script>
...
function toast(t){const e=document.getElementById('msg');e.textContent=t;e.style.display='block';clearTimeout(window.__toast);window.__toast=setTimeout(()=>e.style.display='none',2200)}
draw();
</script>
</body>
</html>'''
